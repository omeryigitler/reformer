    ...
    <header className="rpm-site-header fixed inset-x-0 top-0 z-[80] pointer-events-none">
      <div className="mx-auto flex w-full items-start justify-between">
        ...
        <div className="flex items-center pointer-events-auto">
          ...
          >
            <div className="menu-bg absolute inset-0 z-0 translate-y-full transition-transform duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] group-hover:translate-y-0" />
            <div className="relative z-10 flex h-full w-full flex-col items-center justify-center overflow-hidden">
              <span className="rpm-header-control-label menu-default absolute inset-0 flex items-center justify-center transition-transform duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] group-hover:-translate-y-full">
                menu
              </span>
              <span className="rpm-header-control-label menu-hover absolute inset-0 flex translate-y-full items-center justify-center transition-transform duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] group-hover:translate-y-0">
                menu
              </span>
            </div>
          </button>
